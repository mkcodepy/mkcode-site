...
import { Container, Eyebrow, TechLabel } from "@/components/layout/Container";
            ...
            >
              ...
              <span className="relative inline-block text-ink">
                ...
                <span
                  ...
                  style={{ animation: "mk-fade-up 1.1s ease-out 0.5s both" }}
                />
              </span>
            </motion.h1>
...
function SystemVisualization({ dict }: { dict: ReturnType<typeof getDict> }) {
  ...
  return (
    <div className="relative rounded-lg border border-line bg-surface/40 p-5 backdrop-blur-md">
      ...
      {/* Console */}
      <TerminalBox className="mt-3" prompt={h.consolePrompt} steps={h.consoleSteps as unknown as string[]} />
